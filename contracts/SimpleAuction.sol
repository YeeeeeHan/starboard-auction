...
contract SimpleAuctionFactory {
    ...
    constructor() {
        address newNFT = address(new AuctionNft());
        auctionNft = newNFT;
    ...
    function createAuction(uint biddingTime) public {
        ...
        address newAuction = address(new SimpleAuction(biddingTime, beneficiary, auctionNft));
        auctions.push(newAuction);
        emit AuctionCreated(newAuction); // emit an event with the address of the new auction

        // Add ownership of the NFT contract to the auction
        AuctionNft(auctionNft).addAuctionContract(newAuction);
    }
...
contract SimpleAuction is Ownable {
    address public auctionNftAddress;
    ...
    constructor(uint biddingTime, address payable beneficiaryAddress, address nftAddress) {
        auctionNftAddress = nftAddress;
    ...
    function auctionEnd() external onlyBeneficiary {
        ...
        AuctionNft(auctionNftAddress).safeMint(highestBidder, highestBid);
    }
}
